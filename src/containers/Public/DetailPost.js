        ...
        <Col xs={24} md={24} lg={8}>
          <aside className="flex flex-col gap-4">
            <div className="flex flex-col items-center gap-2 bg-[#febb02] rounded-md p-4">
              ...
              {loading ? (
                <SkeletonCutom className={"min-w-200 p-2"} />
              ) : (
              ...
              {loading ? (
                ...
                <Button
                  isBefore
                  Icon={
                    lovePosts.some((post) => post.postId === postDetail.id) ? BsHeart : BsHeartFill
                  }
                  bgColor={"bg-white"}
                  text={`${
                  ...
                  className={`border-2 h-[40px] text-sm font-bold min-w-200 sm:w-auto w-full ${
                    lovePosts.some((post) => post.postId === postDetail.id)
                      ? "border-pink-600"
                      : "border-gray-800 "
                  }`}
