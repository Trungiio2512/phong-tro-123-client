...
const Search = () => {
  ...
  const handleSearch = () => {
    ...
    const titleSearch = `${queriesObjText.category ? queriesObjText.category : "Cho thuê tất cả"} ${
  ...
  return (
    <>
      <div className="p-[10px] rounded-lg bg-[#febb02] flex flex-col md:flex-row items-center justify-around gap-2 w-full">
        <div
