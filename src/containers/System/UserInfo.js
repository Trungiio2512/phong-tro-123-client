  ...
  return (
    <div className="h-full mb-10">
      <div className="flex items-center justify-between border-b-1 border-gray-300">
        <h1 className="font-semibold text-3xl pb-4 ">Cập nhật thông tin cá nhân</h1>
      </div>
      <div className="flex flex-col gap-6 max-w-[700px] m-auto mt-6">
        ...
        <div className="flex items-center">
          ...
          <figure className="rounded-full w-40 h-40 border border-gray-300 overflow-hidden">
            <img src={payload.avatar} alt="avatar" className="w-full h-full object-cover" />
          </figure>
        </div>

        <input className="ml-200" type="file" onChange={(e) => handleChangeAvatar(e)} id="avatar" />
        <div className="flex items-center ">
